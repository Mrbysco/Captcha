	...
	protected void init() {
		...
		this.addRenderableWidget(
				new Button(this.width / 2 + 40, topPos + yOffset, 80, 20,
						Component.translatable("captcha.winrar.buy"), (button) -> {
		...
		this.addRenderableWidget(
				new Button(this.width / 2 + 40, topPos + yOffset, 80, 20,
						Component.translatable("captcha.winrar.how"), (button) -> {
					//Open Rick Astley
		...
		this.addRenderableWidget(
				new Button(this.width / 2 + 40, topPos + yOffset, 80, 20,
						Component.translatable("captcha.winrar.close"), (button) -> {
					completeCaptcha();
				})
		);
		yOffset += 22;
		this.addRenderableWidget(
				new Button(this.width / 2 + 40, topPos + yOffset, 80, 20,
						Component.translatable("captcha.winrar.help"), (button) -> {
